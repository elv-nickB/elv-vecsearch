...
def main():
    ...
    search_space = {
        'K': {'_type': 'quniform', '_value': [1, 5, 1]},
        'T': {'_type': 'uniform', '_value': [0.6, 1]},
    }

    experiment.config.trial_command = f'python eval_nni.py --auth {args.auth} --qid {args.qid} --samples {args.samples} --data {args.data}'
